 ...
 *
 * @category Class
 * @description Orders for nominating a neighbour that is eligible to receive the shipment, if the original recipient
 *     is absent. Neighbours are supposed to reside in proximity to the original recipient, i.e., in another apartment
 *     in the same house, on the opposite street side, or next to the house of the original recipient.
 * @package  Dhl\ParcelManagement
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PreferredNeighbourOrder implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['salutation']) && !in_array(
        ...
        if (!preg_match(
            "/[a-z,A-Z,0-9,Ä,Ü,Ö,ä,ü,ö,ß,\\s,\\,,\\.,\\(,\\),\\!,\\-,\/]*$/",
            $this->container['houseNumber']
        )) {
            $invalidProperties[] = "invalid value for 'houseNumber', must be conform to the pattern /[a-z,A-Z,0-9,Ä,Ü,Ö,ä,ü,ö,ß,\\s,\\,,\\.,\\(,\\),\\!,\\-,\/]*$/.";
        }

        if (!is_null($this->container['addressAddition']) && !preg_match(
            "/[a-z,A-Z,0-9,Ä,Ü,Ö,ä,ü,ö,ß,\\s,\\,,\\.,\\(,\\),\\!,\\-,\/]*$/",
            $this->container['addressAddition']
        )) {
    ...
    public function setFirstName($firstName)
    {
        ...
        if ((!preg_match("/[a-z,A-Z,0-9,Ä,Ü,Ö,ä,ü,ö,ß,\\s,\\,,\\.,\\(,\\),\\!,\\-,\/]*$/", $firstName))) {
            throw new \InvalidArgumentException(
                "invalid value for $firstName when calling PreferredNeighbourOrder., must conform to the pattern /[a-z,A-Z,0-9,Ä,Ü,Ö,ä,ü,ö,ß,\\s,\\,,\\.,\\(,\\),\\!,\\-,\/]*$/."
            );
        }
    ...
    public function setLastName($lastName)
    {
        ...
        if ((!preg_match("/[a-z,A-Z,0-9,Ä,Ü,Ö,ä,ü,ö,ß,\\s,\\,,\\.,\\(,\\),\\!,\\-,\/]*$/", $lastName))) {
            throw new \InvalidArgumentException(
                "invalid value for $lastName when calling PreferredNeighbourOrder., must conform to the pattern /[a-z,A-Z,0-9,Ä,Ü,Ö,ä,ü,ö,ß,\\s,\\,,\\.,\\(,\\),\\!,\\-,\/]*$/."
            );
        }
     ...
     * Sets street
     *
     * @param string $street A street name of the neighbour's location. The `street` name of the preferred neighbour
     *     might differ from the original recipient address just in rare cases, where, e.g., the original  recipient an
     *     the neighbour reside at an intersection.
     *
     * @return $this
     */
    public function setStreet($street)
    {
        ...
        if ((!preg_match("/[a-z,A-Z,0-9,Ä,Ü,Ö,ä,ü,ö,ß,\\s,\\,,\\.,\\(,\\),\\!,\\-,\/]*$/", $street))) {
            throw new \InvalidArgumentException(
                "invalid value for $street when calling PreferredNeighbourOrder., must conform to the pattern /[a-z,A-Z,0-9,Ä,Ü,Ö,ä,ü,ö,ß,\\s,\\,,\\.,\\(,\\),\\!,\\-,\/]*$/."
            );
        }
    ...
    public function setHouseNumber($houseNumber)
    {
        ...
        if ((!preg_match("/[a-z,A-Z,0-9,Ä,Ü,Ö,ä,ü,ö,ß,\\s,\\,,\\.,\\(,\\),\\!,\\-,\/]*$/", $houseNumber))) {
            throw new \InvalidArgumentException(
                "invalid value for $houseNumber when calling PreferredNeighbourOrder., must conform to the pattern /[a-z,A-Z,0-9,Ä,Ü,Ö,ä,ü,ö,ß,\\s,\\,,\\.,\\(,\\),\\!,\\-,\/]*$/."
            );
        }
     ...
     *
     * @param string $addressAddition Additional optional information about the neighbour's address, e.g., his or her
     *     apartment number.
     *
     * @return $this
     */
    public function setAddressAddition($addressAddition)
    {
        ...
        if (!is_null($addressAddition) && (!preg_match(
            "/[a-z,A-Z,0-9,Ä,Ü,Ö,ä,ü,ö,ß,\\s,\\,,\\.,\\(,\\),\\!,\\-,\/]*$/",
            $addressAddition
        ))) {
            throw new \InvalidArgumentException(
                "invalid value for $addressAddition when calling PreferredNeighbourOrder., must conform to the pattern /[a-z,A-Z,0-9,Ä,Ü,Ö,ä,ü,ö,ß,\\s,\\,,\\.,\\(,\\),\\!,\\-,\/]*$/."
            );
        }
