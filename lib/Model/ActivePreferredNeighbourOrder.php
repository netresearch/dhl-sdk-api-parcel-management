...
class ActivePreferredNeighbourOrder implements ModelInterface, ArrayAccess
{
     ...
     * Sets description
     *
     * @param string $description A description of the nominated preferred neighbour. If the respective order has been placed using this API, thedescription is supposed to have the following format:  `<salutation> <firstName> <lastName>, <street> <houseNumber>, <addressAddition>`
     *
     * @return $this
     */
    public function setDescription($description)
    {
        if ((mb_strlen($description) > 100)) {
            throw new \InvalidArgumentException('invalid length for $description when calling ActivePreferredNeighbourOrder., must be smaller than or equal to 100.');
        }
